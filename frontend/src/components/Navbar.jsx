    ...
    <>
      <nav className="shadow-sm flex flex-wrap items-center justify-between px-12 py-4">
        ...
        <div className="overflow-hidden border border-slate-400 flex gap-4 items-center justify-between w-350 h-10 rounded-md">
          <input type="text" className="pl-2 h-full w-full outline-none" />
          <img className="cursor-pointer w-5 hover:scale-125 transition-all duration-200 active:scale-100 mr-4" src="https://img.icons8.com/ios-filled/50/525050/search--v1.png" alt="search--v1"/>
        </div>
